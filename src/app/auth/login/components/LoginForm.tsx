...
const LoginForm = () => {
  ...
  <div className="flex min-h-screen bg-white dark:bg-black">
    ...
    <div className="flex flex-row w-full">
      ...
      <div className='hidden lg:flex flex-col justify-between dark:bg-[#000440] bg-[#88ff73] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
        ...
        <div className='space-y-5'>
          ...
          <a href="../auth/register"
            className="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium dark:border-black dark:bg-black dark:text-white border-white bg-white text-black">Create
            account here</a>
        </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
        ...
        <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
          <div className="flex flex-col space-y-2 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-black dark:text-white">Sign in to account</h2>
            <p className="text-md md:text-xl text-black dark:text-white">Sign up or log in to place the order,no password require!</p>
          </div>
          <div className="flex flex-col max-w-md space-y-5">
            ...
            <input type="password" placeholder="Password" name="password"
              className="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black dark:border-white dark:bg-black rounded-lg font-medium placeholder:font-normal" />
            <button className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium dark:border-white dark:bg-black dark:text-white border-black bg-white text-black">Sign In</button>
